...
class Login:
    def __init__(self, client, screen):
        ...
        self.green_button = pygame.image.load("./assets/buttons/green_button04.png")
        self.login_button = Button(self.screen, self.green_button, text="LOGIN")
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if self.tb_username.active:
                    if event.key == pygame.K_BACKSPACE:
                        ...
                        self.username = ""
                    elif self.tb_username.input.get_width() < self.tb_username.rect.width - 20 and event.key != pygame.K_ESCAPE and event.key != pygame.K_TAB:
                ...
                if self.tb_password.active:
                    if event.key == pygame.K_BACKSPACE:
                        ...
                        self.password = ""
                    elif self.tb_password.input.get_width() < self.tb_password.rect.width - 20 and event.key != pygame.K_ESCAPE and event.key != pygame.K_TAB:
